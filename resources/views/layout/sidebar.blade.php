  ...
  <div class="style_menuBody__ZbUkG d-flex flex-column flex-md-row pt-3 pt-md-0 offcanvas-body">
      ...
      <div class="s-active undefined undefined p-0 searchItem"><button type="button"
          class="searchBtn border-0 btn btn-link"><span
            style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative;"><span
              ...
              alt="logo" sizes="100vw" srcset="_next/static/media/search-icon.fe541e20.svg 450w, _next/static/media/search-icon.fe541e20.svg 992w, _next/static/media/search-icon.fe541e20.svg 1200w,
                 _next/static/media/search-icon.fe541e20.svg 1900w" src="_next/static/media/search-icon.fe541e20.svg"
            ...
            <div class="hd-searchGroup position-relative"><input autocomplete="off" required=""
              ...
              <div class="icon hs-searchIcon searchBtn"><span
                  style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative;"><span
                    ...
                    data-nimg="responsive" sizes="100vw" srcset="_next/static/media/search-black-icon.b9c747f1.svg 450w,
                       _next/static/media/search-black-icon.b9c747f1.svg 992w,
                        _next/static/media/search-black-icon.b9c747f1.svg 1200w,
                         _next/static/media/search-black-icon.b9c747f1.svg 1900w"
              ...
              </div><button type="submit" class="icon hs-searchBtn theme-btn small-btn btn btn-primary">Search</button>
            </div>
    ...
    <div class="style_tabSection__WdgKK">
      ...
      <div class="tab-content">
        <div id="left-tabs-example-tabpane-first" aria-labelledby="left-tabs-example-tab-first" class="tab-pane active">
            ...
            <div onclick="accordionClickHandler(this)" class="accordion-item">
              ...
              <div class="accordion-collapse collapse">
                <div class="accordion-body"><button type="button" class="icon-btn btn btn-link"><a
                    ...
                    class="icon-btn btn btn-link"><a href="/t20/t20-blast/">T20 Blast</a></button><button type="button"
                    class="icon-btn btn btn-link"><a href="/ashes/">The Ashes 2023</a></button><button type="button"
                    class="icon-btn btn btn-link"><a href="/cwc-cricket-world-cup/">ICC Cricket World
            ...
            <div onclick="accordionClickHandler(this)" class="accordion-item">
              ...
              <div class="accordion-collapse collapse">
                <div class="accordion-body"><button type="button" class="icon-btn btn btn-link"><a
                    ...
                    class="icon-btn btn btn-link"><a href="/t20/t20-blast/">T20 Blast</a></button><button type="button"
                    class="icon-btn btn btn-link"><a href="/ashes/">The Ashes 2023</a></button><button type="button"
                    class="icon-btn btn btn-link"><a href="/t20/tnpl/">TNPL 2023</a></button><button type="button"
                    class="icon-btn btn btn-link"><a href="/t20/saurashtra-premier-league/">SPL
            ...
            <div onclick="accordionClickHandler(this)" class="accordion-item">
              ...
              <div class="accordion-collapse collapse">
                <div class="accordion-body"><button type="button" class="icon-btn btn btn-link"><a
                    ...
                    class="icon-btn btn btn-link"><a
                      href="/t20/ipl-indian-premier-league/lucknow-super-giants/">LSG</a></button><button type="button"
                    class="icon-btn btn btn-link"><a
