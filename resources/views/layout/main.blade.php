...
<body id="body" data-mode="light">
  ...
  <ul class="fixed false mobileMenu d-flex d-md-none text-center text-uppercase font-semi mb-0">
    <li><a class="active" href="/"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
          xmlns="http://www.w3.org/2000/svg">
          <g id="home-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <polygon id="Path" fill="#212121" fill-rule="nonzero"
              points="10 20.5 10 14.5 14 14.5 14 20.5 19 20.5 19 12.5 22 12.5 12 3.5 2 12.5 5 12.5 5 20.5"></polygon>
          </g>
        </svg>Home </a></li>
    <li><a class="false" href="/live-scores/"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
          xmlns="http://www.w3.org/2000/svg">
    ...
    <li><button onclick="toggleSideMenu()" title="More" type="button" class="w-100 btn btn-link"><svg width="32px"
          ...
          <g id="menu-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <g id="Group">
              ...
              <path
                d="M27,20.8 L25.7150442,24 L5,24 L6.28495575,20.8 L27,20.8 Z M27,14.4 L27,17.6 L5,17.6 L5,14.4 L27,14.4 Z M27,8 L25.7150442,11.2 L5,11.2 L6.28495575,8 L27,8 Z"
