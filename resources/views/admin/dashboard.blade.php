    ...
    <div class="row g-0">
      <div class="col-lg-8 col-12 pe-lg-2">
        <div class="card mb-2 p-4 p-sm-5">
          ...
          <div class="card-body p-0">
            <div class="overview js-animate-tabs p-2">
              <div class="tabs nav flex-nowrap">
                <div class="tab d-xs-block d-sm-flex" id="overview-1" data-bs-target="#overview-item-1"
                  ...
                  <div class="balance d-inline-flex align-items-center px-1 down ms-auto fill"
                ...
                <div class="tab d-xs-block d-sm-flex" id="overview-2" data-bs-target="#overview-item-2"
                  ...
                  <div class="balance d-inline-flex align-items-center px-1 up ms-auto fill"
                    title="Core - Dashboard Builder">
                    <svg class="icon icon-arrow-up me-1 d-block">
                      <use xlink:href="#icon-arrow-up"></use>
                    </svg>38.2%<span> </span>
            ...
            <div class="overview-container tab-content">
              <div class="tab-pane overview-item fade active show" id="overview-item-1" role="tabpanel"
                aria-labelledby="overview-1">
                <div class="users">
                  <div class="users-head d-flex align-items-center justify-content-between mb-4">
                    <div class="users-info">Welcome <b>857 customers</b> with a personal message 😎</div><a
                      class="btn-stroke" href="message-center.html">Send <span
                        class="ms-1 d-none d-sm-block">message</span></a>
                  </div>
                  <div class="users-list d-flex justify-content-around"><a class="users-item text-center"
                      href="message-center.html">
                      <div class="userpic"><img src="{{ asset('admin/img/content/user-2.jpg') }}"></div>
                      <div class="name">Gladyce</div>
                    </a><a class="users-item text-center" href="message-center.html">
                      <div class="userpic"><img src="{{ asset('admin/img/content/user-3.jpg') }}"></div>
                      <div class="name">Elbert</div>
                    </a><a class="users-item text-center" href="message-center.html">
                      <div class="userpic"><img src="{{ asset('admin/img/content/user-4.jpg') }}"></div>
                      <div class="name">Joyce</div>
                    </a><a class="users-item text-center d-none d-sm-block" href="customer-list.html">
              ...
              <div class="tab-pane overview-item fade" id="overview-item-2" role="tabpanel"
                aria-labelledby="overview-2">
        ...
        <div class="card mb-2 p-4 p-sm-5">
          ...
          <div class="card-info">50% of new customers explore products because the author sharing the work on the social
            media network. Gain your earnings right now! 🔥</div>
          <div class="mt-4 d-flex mx-n3"><a class="btn-stroke hover-fill w-100 mx-2"
              ...
              </svg><span class="d-none d-sm-block">Facebook</span></a><a class="btn-stroke hover-fill w-100 mx-2"
              href="https://twitter.com/ui8">
              <svg class="icon icon-twitter me-0 me-sm-2">
                <use xlink:href="#icon-twitter"></use>
              </svg><span class="d-none d-sm-block">Twitter</span></a><a class="btn-stroke hover-fill w-100 mx-2"
          ...
          <div class="popular">
            ...
            <div class="popular-list">
              <div class="popular-item mb-3 py-3 d-flex align-items-center" data-bs-toggle="modal"
                ...
                <div class="popular-preview flex-shrink-0 me-3"> <img srcset="img/content/product-1@2x.jpg 2x"
                    src="{{ asset('admin/img/content/product-1.jpg') }}" alt="Crypter - NFT UI kit" />
                </div>
              ...
              <div class="popular-item mb-3 py-3 d-flex align-items-center" data-bs-toggle="modal"
                data-bs-target="#modal-product">
                <div class="popular-preview flex-shrink-0 me-3"> <img srcset="img/content/product-2@2x.jpg 2x"
                    src="{{ asset('admin/img/content/product-2.jpg') }}" alt="Bento Matte 3D illustration 1.0" />
                </div>
              ...
              <div class="popular-item mb-3 py-3 d-flex align-items-center" data-bs-toggle="modal"
                data-bs-target="#modal-product">
                <div class="popular-preview flex-shrink-0 me-3"> <img srcset="img/content/product-3@2x.jpg 2x"
                    src="{{ asset('admin/img/content/product-3.jpg') }}" alt="Excellent material 3D chair" />
                </div>
              ...
              <div class="popular-item mb-3 py-3 d-flex align-items-center" data-bs-toggle="modal"
                data-bs-target="#modal-product">
                <div class="popular-preview flex-shrink-0 me-3"> <img srcset="img/content/product-4@2x.jpg 2x"
                    src="{{ asset('admin/img/content/product-4.jpg') }}" alt="Fleet - travel shopping kit" />
                </div>
        ...
        <div class="card mb-2 p-4 p-sm-5">
          ...
          <div class="review-card">
            <div class="border-bottom review-item d-flex pb-5 mb-5">
              <div class="review-userpic me-3 flex-shrink-0"><img src="{{ asset('admin/img/content/user-2.jpg') }}"
                  alt="Ethel"></div>
              <div class="review-details flex-grow-1">
                <div class="review-title d-flex align-items-center">
                  <div class="user me-auto"><span class="name">Ethel</span><span
                      class="login ms-1 text-shades-1">@ethel</span></div>
                ...
                <div class="review-control d-flex align-items-center justify-content-between"><a
                    class="review-control-item" href="message-center.html">
            ...
            <div class="border-bottom review-item d-flex pb-5 mb-5">
              <div class="review-userpic me-3 flex-shrink-0"><img src="{{ asset('admin/img/content/user-3.jpg') }}"
                  alt="Jazmyn"></div>
              <div class="review-details flex-grow-1">
                <div class="review-title d-flex align-items-center">
                  <div class="user me-auto"><span class="name">Jazmyn</span><span
                      class="login ms-1 text-shades-1">@ethel</span></div>
            ...
            <div class="border-bottom review-item d-flex pb-5 mb-5">
              <div class="review-userpic me-3 flex-shrink-0"><img src="{{ asset('admin/img/content/user-4.jpg') }}"
                  alt="Ethel"></div>
              <div class="review-details flex-grow-1">
                <div class="review-title d-flex align-items-center">
                  <div class="user me-auto"><span class="name">Ethel</span><span
        ...
        <div class="card mb-2 p-4 p-sm-5">
          ...
          <div class="refound-card">
            <div class="refound-item d-flex align-items-start mb-5">
              ...
              <div class="refound-content ms-3 text-shades-1">You have <b>52 open refund requests</b> to action. This
                includes <b>8 new requests</b>. 👀</div>
