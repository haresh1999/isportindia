...
@section('title','CricSpecial Edit')
...
<div class="page pt-5 px-4 pt-sm-6 px-sm-5 pt-xl-7 px-xl-7">
    <div class="page-head">
        <div class="h3 mb-4 mb-xl-5">Edit CricSpecial</div>
    </div>
            ...
            <div class="col-lg-8 col-12 pe-lg-2">
                <div class="card mb-2 p-4 p-sm-5">
                    <div class="card-head d-flex align-items-center justify-content-between mb-5 mb-sm-6">
                        <div class="title title-color green">CricSpecials & News</div><a class="btn-stroke btn-small"
                    ...
                    <form action="{{ route('cricspecial.update',$res->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body p-0">
                            ...
                            <textarea class="form-control mb-5 mb-sm-6" name="short_description" rows="3"
                                cols="10">{{ $res->short_description }}</textarea>
                            ...
                            <textarea id="editor1" name="description" rows="10"
                                cols="80">{{ $res->description }}</textarea>
                            <br>
                            ...
                            <select class="select select-wide" name="status">
                                <option {{ $res->stauts==1 ? 'selected' : '' }} selected value="1">Active</option>
                                <option {{ $res->stauts==2 ? 'selected' : '' }} value="2">InActive</option>
                            </select>
