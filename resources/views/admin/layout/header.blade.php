<div class="search-header me-auto">
  ...
  <div class="search-input input-group">
    ...
    <input class="form-control rounded-2" type="text" placeholder="Search or type a command"
      aria-describedby="search-input">
    <div class="input-group-text justify-content-end">
      <button class="d-flex align-items-center justify-content-center btn-command"><span
          class="symbol">⌘</span>F</button>
    ...
    <div class="group">
      ...
      <div class="list mb-4">
        <div class="item d-flex py-3"><a class="link d-flex align-items-center flex-fill">
            <div class="thumb"><img srcset="{{ asset('admin/img/content/image-05@2x.jpg 2x') }}"
                src="{{ asset('admin/img/content/image-05.jpg') }}" alt="Put your title here" />
            </div>
        ...
        <div class="item d-flex py-3"><a class="link d-flex align-items-center flex-fill">
            <div class="thumb"><img srcset="{{ asset('admin/img/content/image-06@2x.jpg 2x') }}"
                src="{{ asset('admin/img/content/image-06.jpg') }}" alt="Put your title here" />
            </div>
            <div class="description">
              <div class="caption">Small caption</div>
              <div class="group-title">Put your title here</div>
...
<div class="navbar"><a class="btn btn-primary nav-item create" href="products-add.html" role="button">
  ...
  <div class="nav-item messages-item toggle-item">
    ...
    <div class="toggle-body">
      ...
      <div class="message-list mb-4"><a
          class="item d-flex align-items-center justify-content-start p-3 position-relative" href="message-center.html">
          <div class="userpic flex-shrink-0 me-3 position-relative online"><img class="w-100"
              src="{{ asset('admin/img/content/user-2.jpg') }}" /></div>
        ...
        </a><a class="item d-flex align-items-center justify-content-start p-3 position-relative"
          href="message-center.html">
          <div class="userpic flex-shrink-0 me-3 position-relative online"><img class="w-100"
              src="{{ asset('admin/img/content/user-3.jpg') }}" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
        ...
        </a><a class="item d-flex align-items-center justify-content-start p-3 position-relative new"
          href="message-center.html">
          <div class="userpic flex-shrink-0 me-3 position-relative"><img class="w-100"
              src="{{ asset('admin/img/content/user-4.jpg') }}" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
          ...
          href="message-center.html">
          <div class="userpic flex-shrink-0 me-3 position-relative online"><img class="w-100"
              src="{{ asset('admin/img/content/user-5.jpg') }}" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
          ...
          href="message-center.html">
          <div class="userpic flex-shrink-0 me-3 position-relative"><img class="w-100"
              src="{{ asset('admin/img/content/user-6.jpg') }}" /></div>
          <div class="content w-100">
            <div class="item-title mb-1 d-flex align-items-center justify-content-between">
  ...
  <div class="nav-item notification-item toggle-item">
    ...
    <div class="toggle-body">
      ...
      <div class="list-notifications mb-4"><a class="item d-flex align-items-center p-3 position-relative new"
          href="/notification.html">
          <div class="userpic flex-shrink-0 me-3 position-relative">
            <div
              class="notify-icon d-flex align-items-center justify-content-center end-0 bottom-0 position-absolute blue">
              <svg class="icon icon-messages-fill">
                <use xlink:href="#icon-messages-fill"></use>
              </svg>
            </div><img class="w-100" src="{{ asset('admin/img/content/user-2.jpg') }}" />
          </div>
          <div class="content w-100">
        ...
        </a><a class="item d-flex align-items-center p-3 position-relative new" href="/notification.html">
          <div class="userpic flex-shrink-0 me-3 position-relative">
            <div
              class="notify-icon d-flex align-items-center justify-content-center end-0 bottom-0 position-absolute red">
              <svg class="icon icon-heart-fill">
                <use xlink:href="#icon-heart-fill"></use>
              </svg>
            </div><img class="w-100" src="{{ asset('admin/img/content/user-3.jpg') }}" />
          </div>
          <div class="content w-100">
            <div class="item-title d-flex align-items-center justify-content-between">
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative">
            <div
              class="notify-icon d-flex align-items-center justify-content-center end-0 bottom-0 position-absolute green">
              <svg class="icon icon-shopping-bag-fill">
                <use xlink:href="#icon-shopping-bag-fill"></use>
              </svg>
            </div><img class="w-100" src="{{ asset('admin/img/content/user-4.jpg') }}" />
          </div>
          <div class="content w-100">
            <div class="item-title d-flex align-items-center justify-content-between">
              <div class="name me-1">Janice</div>
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative">
            <div
              class="notify-icon d-flex align-items-center justify-content-center end-0 bottom-0 position-absolute purple">
              <svg class="icon icon-star-fill">
                <use xlink:href="#icon-star-fill"></use>
              </svg>
            </div><img class="w-100" src="{{ asset('admin/img/content/user-5.jpg') }}" />
          </div>
          <div class="content w-100">
            <div class="item-title d-flex align-items-center justify-content-between">
          ...
          <div class="userpic flex-shrink-0 me-3 position-relative">
            ...
            </div><img class="w-100" src="{{ asset('admin/img/content/user-6.jpg') }}" />
          </div>
          <div class="content w-100">
            <div class="item-title d-flex align-items-center justify-content-between">
